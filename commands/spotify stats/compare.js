  ...
  options: [
    ...
    callback: async ({ client, message, interaction, args, text, channel, guild, version }) => {
      //Importing the data
        ...
        var spotify1 = spotifyEins1.concat(spotifyZwei1, spotifyDrei1, spotifyVier1);spotify1
        ...
        switch (dinge) {
            ...
            case "artistinfo":
                ...
                var data = getData(artistname);
                var data1 = getData1(artistname);
                break;
            case "overall":
                var data = getData();
                var data1 = getData1();
...
//surch for the song in both data
...
//until here
        //const songname =interaction.options.getString("song").replace(/\s+/g, "-");
        //const data = getData(songname);
        //const data1 = getData1(songname);
